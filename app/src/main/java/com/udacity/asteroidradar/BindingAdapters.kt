...
fun bindAsteroidStatusImage(imageView: ImageView, isHazardous: Boolean) {
    if (isHazardous) {
        ...
        imageView.contentDescription =
            imageView.context.getString(R.string.potentially_hazardous_asteroid_status_icon)
    } else {
        imageView.setImageResource(R.drawable.ic_status_normal)
        imageView.contentDescription =
            imageView.context.getString(R.string.not_hazardous_asteroid_status_icon)
    }
}
